	...
	<div id="container"><!-- START container -->
		<div class="row">
			<div class="col-md-12 hauteur_map" style="box-sizing:border-box;">
				<div class="toggle tooltips" id="toggle_line" 	 data-placement="left" data-toggle="tooltip" title="Voir les lignes"><span id="on_toggle_line" class="glyphicon glyphicon-list"></span></div>
				<div class="toggle tooltips" id="toggle_tmpreel" data-placement="left" data-toggle="tooltip" title="Bus en temps réel"><span id="on_toggle_tmpreel" class=""><img id="img_toggle_tmpreel" src="/static/img/map/pack/bus-18@2x-play.png" /></span></div>
				<div class="toggle tooltips" id="toggle_velo" 	 data-placement="left" data-toggle="tooltip" title="Voir les zones VeloStan"><span id="on_toggle_velo" class=""><img id="img_toggle_velo" src="/static/img/map/pack/bicycle-18@2x.png" /></span></div>
				<div class="toggle tooltips" id="toggle_autopi"  data-placement="left" data-toggle="tooltip" title="Voir les zones Autopi"><span id="on_toggle_autopi" class=""><img id="img_toggle_autopi" src="/static/img/map/pack/car-18@2x.png" /></span></div>
				<div class="toggle tooltips" id="toggle_parking" data-placement="left" data-toggle="tooltip" title="Voir les parkings"><span id="on_toggle_parking" class=""><img id="img_toggle_parking" src="/static/img/map/pack/parking-18@2x.png" /></span></div>
				<div class="toggle tooltips" id="toggle_gare" 	 data-placement="left" data-toggle="tooltip" title="Voir les gares"><span id="on_toggle_gare" class=""><img id="img_toggle_gare" src="/static/img/map/pack/rail-18@2x.png" /></span></div>
				<div class="toggle tooltips" id="toggle_train" 	 data-placement="left" data-toggle="tooltip" title="Voir les trains"><span id="on_toggle_train" class=""><img id="img_toggle_train" src="/static/img/map/train/rail-18@2x_play.png" /></span></div>
				<div class="toggle tooltips" id="toggle_config"  data-placement="left" data-toggle="tooltip" title="Configuration"><span id="on_toggle_config" class="glyphicon glyphicon-cog" data-toggle="modal" data-target="#myModal"></span></div>

				<div id="zone_left" style="display:none;">
					<div class="ligne_min">
				...
				<div id="zone_right">
					<div id="zone_menu_right">
						<div id="titre">
							<div id="logo">
								<img src="http://mapstan.fr/static/img/logo_mapstan.png" alt="MapStan" />
							</div>
							<div>
								<h1 class="titre_site">MapStan</h1> <a style="float:left;" href="http://wiki.mapstan.fr">[Espace Wiki]</a>
							</div>
						</div>
						<div class="clearfix"></div>
						<div style="margin-left:50px;">
							<div class="fb-like" data-href="http://map.lapp.li" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://map.lapp.li" data-via="FabriceSimonet" data-lang="fr">Tweet</a>
						</div>
					</div>
