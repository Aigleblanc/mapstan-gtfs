<?php 
    $this->view('admin/structure/header');
    $this->view('admin/structure/nav');
?>

    <div id="page-container">

<?php 
    $this->view('admin/structure/sidebar');
?>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                <div class="tiles-heading">Rapports en attente</div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-success" href="#">
                                <div class="tiles-heading">Rapports publiés</div>
                                <div class="tiles-body-alt">
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-orange" href="#">
                                <div class="tiles-heading">xxxx</div>
                                <div class="tiles-body-alt">
...
<?php 
    $this->view('admin/structure/footer');
?>