        ...
        <nav id="page-leftbar" role="navigation">
            ...
            <ul class="acc-menu" id="sidebar">
                ...
                <li class="divider"></li>
                <li><a href="#"><i class="fa fa-home"></i> <span>Reseau Stan</span></a></li>

                <li><a href="javascript:;"><i class="fa  fa-user"></i> <span>Lignes</span></a>
                    <ul class='acc-menu'>
                        <li><a href="/admin/lignes/liste">Voir la liste</a></li>
                        <li><a href="/admin/lignes/importer">Importer</a></li>
                    </ul>
                </li>
                <li><a href="javascript:;"><i class="fa fa-th"></i> <span>Arrets</span></a>
                    <ul class="acc-menu">
                        <li><a href="/admin/arrets/liste"><span>Voir la liste</span></a>
                        <li><a href="/admin/arrets/importer"><span>Importer</span></a>   
                    </ul>
                </li>
                <li><a href="javascript:;"><i class="fa fa-envelope"></i> <span>Horaires</span></a>
                    <ul class="acc-menu">
                        <li><a href="/admin/horaire/liste">Voir la liste</a></li>
                        <li><a href="/admin/horaire/importer">Importer</a></li>
                    </ul>
                </li>
                <li><a href="javascript:;"><i class="fa fa-envelope"></i> <span>Rapport</span></a>
                    <ul class="acc-menu">
                        <li><a href="/admin/rapport/liste">Voir la liste</a></li>
                    </ul>
                </li>
                <li><a href="javascript:;"><i class="fa fa-envelope"></i> <span>Statistiques</span></a>
                    <ul class="acc-menu">
                        <li><a href="/admin/stats/liste">Voir la liste</a></li>
                    </ul>
                </li>                

                <li class="divider"></li>
                <li><a href="#"><i class="fa fa-home"></i> <span>Autopi</span></a></li>

                <li><a href="#"><i class="fa fa-home"></i> <span>Emplacement</span></a>                    
                    <ul class="acc-menu">
                        <li><a href="/admin/autopi/placement">Voir les placements</a></li>
                        <li><a href="/admin/autopi/importer">Importer</a></li>
                    </ul></li>                
                

                <li class="divider"></li>
                <li><a href="#"><i class="fa fa-home"></i> <span>VeloStan</span></a></li>

                <li><a href="#"><i class="fa fa-home"></i> <span>Emplacement</span></a>                    
                    <ul class="acc-menu">
                        <li><a href="/admin/velostan/placement">Voir les emplacements</a></li>
                        <li><a href="/admin/velostan/importer">Importer</a></li>
                    </ul></li>

                <li class="divider"></li>
                <li><a href="#"><i class="fa fa-home"></i> <span>Parking</span></a></li>

                <li><a href="#"><i class="fa fa-home"></i> <span>Emplacement</span></a>                    
                    <ul class="acc-menu">
                        <li><a href="/admin/parking/placement">Voir les placements</a></li>
                        <li><a href="/admin/parking/importer">Importer</a></li>
                    </ul></li>
            </ul>
            <!-- END SIDEBAR MENU -->
        </nav>
